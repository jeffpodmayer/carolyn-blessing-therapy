...
const Experience: React.FC = () => {
  return (
    <section
      id="experience"
      className="bg-slate-50 px-4 md:px-8 py-4 mb-8 scroll-mt-[75px]"
    >
      <div className="max-w-[1200px] mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-primary text-2xl md:text-4xl mb-4 font-bold">
            Experience & Training
          </h1>
        ...
        <div className="flex flex-col md:flex-row gap-8 max-w-[1200px] mx-auto">
          <div className="flex-1 bg-white rounded-lg p-8 shadow-lg text-center">
            <h3 className="font-bold text-blue-600 mb-6 text-xl">Training</h3>
          ...
          <div className="flex-1 bg-white rounded-lg p-8 shadow-lg text-center">
            <h3 className="font-bold text-blue-600 mb-6 text-xl">Experience</h3>
            <ul className="list-none p-0 text-left">
              <li className="py-3 text-gray-600 border-b border-slate-200 leading-relaxed">
